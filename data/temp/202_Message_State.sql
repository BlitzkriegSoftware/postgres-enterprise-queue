-- Table: test01.message_state

DROP TABLE IF EXISTS test01.message_state;

CREATE TABLE IF NOT EXISTS test01.message_state
(
...
ALTER TABLE IF EXISTS test01.message_state
    OWNER to postgres;